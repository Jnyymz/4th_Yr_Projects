...
class Proposal extends Database {
    ...
    public function createProposal($user_id, $description, $image, $min_price, $max_price, $category_id) {
    $sql = "INSERT INTO proposals
            (user_id, description, image, min_price, max_price, category_id, date_added)
            VALUES (?, ?, ?, ?, ?, ?, NOW())";
