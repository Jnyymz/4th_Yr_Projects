...
<div class="glass-box col-md-4 text-white">
  <h2 class="fw-semibold text-center mb-2">Create Account</h2>
  <p class="text-center opacity-75 mb-4">Register to get started</p>
  ...
  <button onclick="register()" class="btn custom-btn w-100 mb-3">Register</button>
